...
JPN_NUM_EXPR = ((C("零") | C("〇") | C("ぜ") >> -C("ー") >> C("ろ") | C("れ") >> -C("ー") >> C("い")) >> R(0)
                ...
                | (C("四") | C("肆") | C("よ") >> -C("ー") >> C("ん")) >> R(4)
                | (C("五") | C("伍") | C("ご") >> -C("ー") >> (C("お") | C("う")).opt) >> R(5)
                | (C("六") | C("陸") | C("ろ") >> -C("ー") >> C("く")) >> R(6)
                | (C("七") | C("柒") | C("な") >> -C("ー") >> C("な") | C("し") >> -C("ー") >> C("ち")) >> R(7)
                | (C("八") | C("捌") | C("は") >> -C("ー") >> C("ち")) >> R(8)                
                | (C("九") | C("玖") | S("きゅ") >> -C("ー") >> C("う").opt | C("く")) >> R(9))
